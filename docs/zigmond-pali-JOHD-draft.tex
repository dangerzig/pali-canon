...
Despite 97.7\% lemmatization coverage, 3,002 unique word forms remain unresolved. Analysis reveals that 96\% of these originate from the Khuddaka Nikāya---particularly technical texts like Netti, Cūḷaniddesa, and narrative works like the Jātaka. These include:
...
Only 113 unknown forms appear in the four main nikāyas (DN, MN, SN, AN), indicating near-complete coverage for the most studied texts. A supplementary file lists all unresolved forms for potential manual review or future DPD updates.
