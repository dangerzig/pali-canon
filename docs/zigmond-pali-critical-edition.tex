...
The remaining 3,002 word forms (2.4\%) not resolved by the lemmatizer are genuine candidates for future DPD expansion. Analysis reveals that 96\% originate from the Khuddaka Nikāya---particularly the Jātaka, Apadāna, Milindapañha, Netti, and Cūḷaniddesa/Mahāniddesa. These texts contain:
...
Only 113 unknown forms appear in the four main nikāyas (DN, MN, SN, AN), indicating that the lemmatizer achieves near-complete coverage for the most frequently studied texts.
